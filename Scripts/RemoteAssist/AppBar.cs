...
namespace HoloToolkit.Unity.UX
{
    ...
    public class AppBar : InteractionReceiver
    {
        ...
        {
            public ButtonTemplate(ButtonTypeEnum type, string name, string icon, string text, string icon1, string text1, int defaultPosition, int manipulationPosition)
            {
                Type = type;
                Name = name;
                Icon = icon;
        ...
        private void FollowBoundingBox(bool smooth)
        {
            ...
            float maxXYScale = Mathf.Max(scale.x, scale.y, scale.z) / 2;  //binxie
            ...
            {
                float realExtend = i % 2 == 0 ? scale.z / 2 : scale.x / 2;

                Vector3 nextPosition = boundingBox.transform.position +
                (forwards[i] * - realExtend) +
            ...
            switch (type)
            {
                ...
                case ButtonTypeEnum.Adjust:
                    ...
                    return new ButtonTemplate(
                        ...
                        "Adjust",
                        "AdjustHologram", // Replace with your custom icon texture name in HolographicButton prefab
                        "调整",
                        "AdjustHologram", // Replace with your custom icon texture name in HolographicButton prefab
                        "调整",
                ...
                case ButtonTypeEnum.Done:
                    return new ButtonTemplate(
                        ButtonTypeEnum.Done,
                        "Done",
                        "Accept", // Replace with your custom icon texture name in HolographicButton prefab
                        "完成",
                        "Accept", // Replace with your custom icon texture name in HolographicButton prefab
                        "完成",
                        0,
                ...
                case ButtonTypeEnum.Hide:
                    return new ButtonTemplate(
                        ButtonTypeEnum.Hide,
                        "Hide",
                        "HideMenu", // Replace with your custom icon texture name in HolographicButton prefab
                        "隐藏菜单",
                        "HideMenu", // Replace with your custom icon texture name in HolographicButton prefab
                        "隐藏菜单",
                ...
                case ButtonTypeEnum.Remove:
                    ...
                    return new ButtonTemplate(
                        ...
                        "Remove",
                        "RemoveHologram", // Replace with your custom icon texture name in HolographicButton prefab
                        "删除",
                        "RemoveHologram", // Replace with your custom icon texture name in HolographicButton prefab
                        "删除",
                ...
                case ButtonTypeEnum.Show:
                    return new ButtonTemplate(
                        ButtonTypeEnum.Show,
                        "Show",
                        "ShowMenu", // Replace with your custom icon texture name in HolographicButton prefab
                        "显示菜单",
                        "ShowMenu", // Replace with your custom icon texture name in HolographicButton prefab
                        "显示菜单",
                        0,
