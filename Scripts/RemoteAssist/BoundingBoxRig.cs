...
namespace HoloToolkit.Unity.UX
{
    ...
    public class BoundingBoxRig : MonoBehaviour
    {
        ...
        [Header("Real Transform to affect")]
        public Transform realTransformToAffect = null;
        ...
        private void Start()
        {
            ...
            boxInstance.BoundsCalculationMethod = BoundingBox.BoundsCalculationMethodEnum.RendererBounds;
        ...
        private void UpdateCornerHandles()
        {
            ...
            if (cornerHandles == null)
            {
                ...
                for (int i = 0; i < cornerHandles.Length; ++i)
                {
                    ...
                    rigScaleGizmoHandles[i].TransformToAffect =  realTransformToAffect == null ?  objectToBound.transform : realTransformToAffect;
        ...
        private void UpdateRotateHandles()
        {
            ...
            if (rotateHandles == null)
            {
                ...
                for (int i = 0; i < rotateHandles.Length; ++i)
                {
                    ...
                    rigRotateGizmoHandles[i].TransformToAffect = realTransformToAffect == null ? objectToBound.transform : realTransformToAffect;
        ...
        public void DestroyAll()
        {
            ...
            Destroy(appBarInstance.gameObject);

            GameObject realObj = realTransformToAffect != null ? realTransformToAffect.gameObject : gameObject;
            Destroy(realObj);
        }
    }
}